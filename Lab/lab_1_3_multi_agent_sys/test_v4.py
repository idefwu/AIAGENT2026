...
# 2. 定義系統提示詞（微調優化，讓作家知道他是基於歷史最佳版本修改）
WRITER_PROMPT = (
...
def run_multi_agent_system(topic: str, max_turns: int = 7):
    ...
    for turn in range(1, max_turns + 1):
        ...
        # 4. 未達門檻，交給編輯 Agent 給予修改建議（編輯此時會看到「歷史最佳」與「讀者反饋」）
        editor_input = (
        ...
        # --- 💡 記憶反饋：強制作家下一輪以「歷史最佳故事」為基底，結合編輯意見進行修改 ---
        current_message = (
...
if __name__ == "__main__":
    run_multi_agent_system(topic="秘密基地裡的時空發電機", max_turns=15)
